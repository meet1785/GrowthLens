...
import { Activity, Mail, AlertCircle } from "lucide-react";
...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen app-shell-bg bg-grid flex items-center justify-center px-4 relative">
      <div className="genz-orb w-44 h-44 bg-sky-400/40 top-16 right-6 animate-float-soft" />
      <div className="genz-orb w-44 h-44 bg-amber-300/35 bottom-10 left-6 animate-float-soft delay-4" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="mb-4 flex justify-center animate-fade-up delay-1">
          <Image
            ...
            alt="Growth analysis sticker"
            width={360}
            height={360}
            className="w-24 h-24 object-contain animate-float-soft"
          />
        </div>
