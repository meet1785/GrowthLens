...
export default function SignInPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-void)] bg-grid flex items-center justify-center px-4 relative">
      {/* Background glow */}
      <div className="absolute top-1/3 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-amber-500/[0.03] rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8 animate-fade-up">
          ...
          <p className="text-[var(--text-muted)] mt-3 text-sm">
            Sign in to analyze products
          </p>
        </div>

        <Card className="animate-scale-in delay-1 glow-amber">
